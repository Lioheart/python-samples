...
"}")
    ...
    def retranslateUi(self, NotifyForm):
        ...
        NotifyForm.setWindowTitle(_translate("NotifyForm", "Tytuł"))
        self.buttonClose.setText(_translate("NotifyForm", "r"))
        self.buttonView.setText(_translate("NotifyForm", "Tekst"))
...
if __name__ == "__main__":
    ...
    b1 = QPushButton(
        "Tekst 1", window, clicked=lambda: notify.show(title='Tytuł', content=b1.text()).showAnimation())
    b2 = QPushButton(
